...
<template>
  <aside
    class="absolute left-0 top-0 z-9999 flex h-screen w-[14rem] flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-gray-600 lg:static lg:translate-x-0"
    :class="{
